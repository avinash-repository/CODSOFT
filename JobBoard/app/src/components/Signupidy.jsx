...
export default function Signupidy() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.checkValidity()) {
      console.log(details);
      try {
        const response = await fetch('http://localhost:3000/api/employers/signup', {
          method: 'POST',
          headers: {
    ...
    <>
      ...
      <div className='p-4'>
        ...
        <form className={`needs-validation ${validated ? 'was-validated' : ''}`} noValidate onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <label htmlFor="validationWebsitelink" className="form-label">Website Link</label>
            <input type="text" name='websitelink' className="form-control" id="validationWebsitelink" autoComplete="name" placeholder='' onChange={onChange} value={details.websitelink} />
          </div>
          <div className="mb-3">
          ...
          <div className="mb-3">
            <label htmlFor="validationAddress" className="form-label">Company Address</label>
          ...
          <div className="mb-3">
            <label htmlFor="validationRePassword" className="form-label">Re-Enter Password</label>
            <input type="password" name='repassword' className="form-control" id="validationRePassword" autoComplete="current-password" required />
            <div className="invalid-feedback">Re-Enter a password</div>
          </div>
          <div className="mb-3">
